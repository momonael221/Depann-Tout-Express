...
import Contact from "../assets/img/dunkerque.webp";
import Serrurier from "../assets/img/serrurier.jpg";

export default function SerrurerieDunkerque() {
    return <>
        <section className="bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-700">
            <div className="container mx-auto py-10">
                <div className="flex items-center justify-between gap-4">
                    <h2 className="text-2xl font-light">Serrurerie Dunkerque</h2>
                ...
                <div className="grid grid-cols-1 gap-10">
                    <div className="col-span-1">
                        <div className="flex flex-col space-y-8">
                            <h2 className={"text-cyan-700 text-3xl font-bold"}>Pour tout dépannage en serrurerie sur Dunkerque et aux environs, <span className="font-light">vous pouvez nous contacter dans toute la région haut de France. Nous intervenons sur Dunkerque et son aglomération, Nous intervenons en urgence ou sur rendez-vous 24H/24, 7J/7 en dépannage de serrure sur Dunkerque, Réparation de serrures à Bailleul, Installations de Portes Blindés Bambecque, Serrurier agrée assurance sur Maubeuge, Changement de serrure et ouvertures de portes à Warhem, Pitgam,  etc...</span></h2>
                        </div>
                    </div>
