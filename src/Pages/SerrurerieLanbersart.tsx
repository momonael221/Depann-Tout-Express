                ...
                <div className="grid grid-cols-1 gap-10">
                    <div className="col-span-1">
                        <div className="flex flex-col space-y-8">
                            <h2 className={"text-cyan-700 text-3xl font-bold"}>Pour tout dépannage en serrurerie sur Lambersart et aux environs, <span className="font-light">vous pouvez nous contacter dans toute la région haut de France. Nous intervenons sur Lambersart et son aglomération, Nous intervenons en urgence ou sur rendez-vous 24H/24, 7J/7 en dépannage de serrure sur Lambersart, Réparation de serrures à Lompret, Installations de Portes Blindés LOOS, Serrurier agrée assurance sur Sequedin, Changement de serrure et ouvertures de portes à Wambrechies, Saint-André-lez-Lille,  etc...</span></h2>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-32">
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <p className={"text-lg"}>Si vous avez besoin d'un dépannage de serrure à Lille, d'une ouverture de porte claquée à Lambersart, vous êtes au bon endroit ! L'entreprise Depann Tout Express dispose de professionnels compétents prêts à vous aider dans ces situations délicates. Que votre cylindre de serrure soit grippé ou que vous souhaitiez remplacer le barillet de votre porte, nos experts sont là pour vous accompagner. Ils assurent notamment la pose de serrures A2P, qu'il s'agisse de serrures trois points ou cinq points.</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-32">
                    ...
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <p>Disponible 24h/24 et 7j/7, notre serrurier peut intervenir dans l'heure pour vos urgences de dépannage dans un rayon d'environ 60 km autour des villes de Lambersart, Lille, et dans tout le département du Nord.</p>
