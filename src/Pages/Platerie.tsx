        ...
        <section className="bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-700">
            <div className="container mx-auto py-10">
                <div className="flex items-center justify-between gap-4">
                    <h2 className="text-gray-900 dark:text-white text-2xl font-light">Services de Plâtrerie</h2>
                    <Breadcrumb aria-label="Chemin de sous-page">
                        <Breadcrumb.Item href="/" icon={HiHome}>Page d'accueil</Breadcrumb.Item>
                        <Breadcrumb.Item>Services de Plâtrerie</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
            </div>
        </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-32">
                    ...
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <Button className={"max-w-sm"} size={"xl"} pill outline>Services de peinture</Button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-10">
                    ...
                    <div className="col-span-1 space-y-4">
                        <p>Vous souhaitez obtenir des informations supplémentaires ? Vous aimeriez recevoir un devis
                            gratuit et détaillé pour estimer le coût de vos travaux ? Contactez ABB Depann Tout Express
                    ...
                    <div className="col-span-1 space-y-4">
                        <Button size={"xl"} pill outline>Joindre notre équipe</Button>
                    </div>
                </div>
            </div>
        </section>
