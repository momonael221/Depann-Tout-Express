                ...
                <div className="grid grid-cols-1 gap-10">
                    <div className="col-span-1">
                        <div className="flex flex-col space-y-8">
                            <h2 className={"text-cyan-700 text-3xl font-bold"}>Pour tout dépannage en serrurerie sur Armentières et aux environs, <span className="font-light">vous pouvez nous contacter dans toute la région haut de France. Nous intervenons sur Armentières et son aglomération, Nous intervenons en urgence ou sur rendez-vous 24H/24, 7J/7 en dépannage de serrure sur Armentières, Réparation de serrures à Houplines, Installations de Portes Blindés Capinghem, Serrurier agrée assurance sur Frelinghien, Changement de serrure et ouvertures de portes à Warneton, Bois-Grenier  etc...</span></h2>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-32">
                    ...
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <p>Disponible 24h/24 et 7j/7, notre serrurier peut intervenir dans l'heure pour vos urgences de dépannage dans un rayon d'environ 60 km autour de Armentières.</p>
