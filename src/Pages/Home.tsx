...
export default function Home() {
    return <>
        <section>
            ...
            <div className="bg-cyan-700 dark:bg-gray-800 text-white dark:text-gray-400 uppercase font-medium w-full flex items-center justify-center py-4 border-b dark:border-gray-800">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    <div className="col-span-1">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <span className="text-white dark:text-gray-400 text-center uppercase">À votre disposition 24H/24, 7J/7</span>
                        </div>
                    </div>
                    <div className="col-span-1">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            <img className="w-20 h-20" src={People} alt={People}/>
                            <span className="text-white dark:text-gray-400 text-center uppercase">Réactivité dans les interventions</span>
                        </div>
                    </div>
                    <div className="col-span-1">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            <img className="w-20 h-20" src={Wallet} alt={Wallet}/>
                            <span className="text-white dark:text-gray-400 text-center uppercase">Options de paiement simples</span>
                        </div>
                    </div>
                </div>
            </div>
