        ...
        <section className="bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-700">
            <div className="container mx-auto py-10">
                <div className="flex items-center justify-between gap-4">
                    <h2 className="text-2xl font-light">Serrurier Tourcoing</h2>
                    <Breadcrumb aria-label="Subpage breadcrumb">
                        <Breadcrumb.Item href="/" icon={HiHome}>Accueil</Breadcrumb.Item>
                        <Breadcrumb.Item>Serrurier Tourcoing</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
            </div>
        </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-32">
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <p className={"text-lg"}>Si vous avez besoin d'un dépannage de serrure à Tourcoing, d'une ouverture de porte claquée à Tourcoing, vous êtes au bon endroit ! L'entreprise Depann Tout Express dispose de professionnels compétents prêts à vous aider dans ces situations délicates. Que votre cylindre de serrure soit grippé ou que vous souhaitiez remplacer le barillet de votre porte, nos experts sont là pour vous accompagner. Ils assurent notamment la pose de serrures A2P, qu'il s'agisse de serrures trois points ou cinq points.</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-32">
                    ...
                    <div className={"col-span-1"}>
                        <div className="flex flex-col space-y-8">
                            ...
                            <p>Disponible 24h/24 et 7j/7, notre serrurier peut intervenir dans l'heure pour vos urgences de dépannage dans un rayon d'environ 60 km autour des villes de Tourcoing, et dans tout le département du Nord.</p>
